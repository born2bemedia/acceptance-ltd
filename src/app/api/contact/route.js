...
export async function POST(request) {
  try {
    ...
    const clientEmailBody = makeBody(
      email, 
      process.env.EMAIL_USER, 
      "Aceptanta: We Received Your Inquiry", 
      `
                ...
                <tr>
                    <td style="padding: 50px 40px;">
                        ...
                        <p style="font-family: 'Roboto', sans-serif; font-size: 16px; font-weight: 400; line-height: 22.4px; color: #0A0A0A; margin: 20px 0;">
                            Thank you for reaching out to us. We have received your inquiry and wanted to let you know that our team is already working on crafting the best possible solution tailored to your needs.
                        </p>
                        <p style="font-family: 'Roboto', sans-serif; font-size: 16px; font-weight: 400; line-height: 22.4px; color: #0A0A0A; margin: 20px 0;">
                            We take pride in delivering customised support, and one of our specialists will be in touch shortly to gather any additional information needed. This ensures that we can provide you with the most effective and optimised outcome.
                        </p>
                        <p style="font-family: 'Roboto', sans-serif; font-size: 16px; font-weight: 400; line-height: 22.4px; color: #0A0A0A; margin: 20px 0;">
                            In the meantime, if you have any further questions or need to share more details, feel free to reply to this email.
                        </p>
                        <p style="font-family: 'Roboto', sans-serif; font-size: 16px; font-weight: 400; line-height: 22.4px; color: #0A0A0A; margin: 20px 0;">
                            Thank you for choosing Aceptanta. We look forward to assisting you.
                        </p>
