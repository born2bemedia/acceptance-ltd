...
const items = [
  ...
  },
  {
    ...
    description:
      "We assist with company formation, account management, legal matters, and financial operations, ensuring your business operates smoothly. Our support extends throughout your business's lifecycle, including dispute resolution and company closure if needed.",
  },
  {
    title: "Transparent and Reliable Partnership",
    description:
      "Our commitment to transparency means you’ll always be informed at every step. We provide clear guidance and ensure that all documentation and administrative processes are handled efficiently and in full accordance with regulations.",
  },
  {
    title: "Proven Success in Risk Mitigation",
    description:
      "We proactively monitor your business’s operations, financial reporting, and legal standing, helping you avoid complications and unnecessary costs. Our expertise ensures your business runs smoothly and meets all regulatory requirements with minimal risk.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Our established partnerships with banks and payment systems across multiple jurisdictions help you navigate account openings, manage financial flows, and resolve banking challenges quickly and effectively.",
  },
];
